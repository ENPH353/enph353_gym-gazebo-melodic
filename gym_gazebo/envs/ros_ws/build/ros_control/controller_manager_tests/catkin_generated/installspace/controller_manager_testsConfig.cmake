...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fizzer/enph353_gym-gazebo/gym_gazebo/envs/ros_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fizzer/enph353_gym-gazebo/gym_gazebo/envs/ros_ws/install/lib;/home/fizzer/enph353_gym-gazebo/gym_gazebo/envs/ros_ws/devel/lib;/home/fizzer/enph353_ws/devel/lib;/opt/ros/melodic/lib)
