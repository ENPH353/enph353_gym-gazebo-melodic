...
#export GYM_GAZEBO_ENV_SCARA4AND3="/media/raid/RL/ros_rl/environments/gym-gazebo/gym_gazebo/envs/installation/../assets/worlds/scara_basic.world"
# ROS 2
# import rclpy
...
class GazeboModularScara4And3DOFv1Env(gazebo_env.GazeboEnv):
    ...
    def __init__(self):
        ...
        self.urdf_path = "/media/raid/RL/ros_rl/environments/gym-gazebo/gym_gazebo/envs/assets/urdf/modular_scara/scara_e1_model_4_and_3joints.urdf"
